export default function Constitution() {
  return (
    <>
      ...
      <p className="sans">Ratified 17 August 2026. Squads locked 20 August 2026. Amendment I (assisted operating mode) ratified. Amendment II (one-off cups in scope for match money only) ratified by all four members.</p>
      <div className="card">
        <h4>Remember</h4>
